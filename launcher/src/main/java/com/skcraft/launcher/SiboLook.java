...
import com.jtattoo.plaf.noire.NoireIconFactory;
 ...
 */
public class SiboLook extends AbstractLookAndFeel {
    ...
    static {
        smallFontProps.setProperty("controlTextFont", "Dialog bold 14");
        smallFontProps.setProperty("systemTextFont", "Dialog bold 14");
        smallFontProps.setProperty("userTextFont", "Dialog 14");
        smallFontProps.setProperty("menuTextFont", "Dialog bold 14");
        smallFontProps.setProperty("windowTitleFont", "Dialog bold 14");
        smallFontProps.setProperty("subTextFont", "Dialog 12");
